...
//For model
float movKit_z = 0.0f;
float rotacion_rueda = 0.0f, 
	direccion = 0.0f,
	direccion_Rueda = 0.0f;
...
void animate(void)
{
	...
	if (play) {
		movKit_z += direccion;
		rotacion_rueda += direccion_Rueda;
	}
...
void display(Shader shader, Model modelo, Model llantas)
{
	...
	model = glm::translate(tmp, glm::vec3(3.6f, -0.5f, 2.4f));
	model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
	model = glm::rotate(model, glm::radians(rotacion_rueda), glm::vec3(1.0, 0.0, 0.0));
	shader.setMat4("model", model);
	llantas.Draw(shader);	//Izq delantera

	model = glm::translate(tmp, glm::vec3(-1.65f, -0.5f, 2.3f));
	model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
	model = glm::rotate(model, glm::radians(rotacion_rueda), glm::vec3(1.0, 0.0, 0.0));
	shader.setMat4("model", model);
	llantas.Draw(shader);	//Der delantera

	model = glm::translate(tmp, glm::vec3(-1.65f, -0.5f, -6.2f));
	model = glm::rotate(model, glm::radians(rotacion_rueda), glm::vec3(1.0, 0.0, 0.0));
	model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
	shader.setMat4("model", model);
	llantas.Draw(shader);	//Der trasera

	model = glm::translate(tmp, glm::vec3(3.6f, -0.5f, -6.2f));
	model = glm::rotate(model, glm::radians(rotacion_rueda), glm::vec3(1.0, 0.0, 0.0));
	model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
	shader.setMat4("model", model);
