...
void LoadTextures()
{
	...
	t_cara_fuego1= generateTextures("Texturas/fuego1.jpg", 0);
	t_cara_fuego2 = generateTextures("Texturas/fuego2.jpg", 0);
	t_cara_fuego3 = generateTextures("Texturas/fuego3.jpg", 0);
	t_cara_fuego4= generateTextures("Texturas/fuego4.jpg", 0);
	t_cara_fuego5 = generateTextures("Texturas/fuego5.jpg", 0);
	t_cara_fuego5 = generateTextures("Texturas/fuego6.jpg", 0);
	...
	glBindTexture(GL_TEXTURE_2D, t_cara_fuego1);
	glActiveTexture(GL_TEXTURE10);
	glBindTexture(GL_TEXTURE_2D, t_cara_fuego2);
	glActiveTexture(GL_TEXTURE11);
	glBindTexture(GL_TEXTURE_2D, t_cara_fuego3);
	glActiveTexture(GL_TEXTURE12);
	glBindTexture(GL_TEXTURE_2D, t_cara_fuego4);
	glActiveTexture(GL_TEXTURE13);
	glBindTexture(GL_TEXTURE_2D, t_cara_fuego5);
	glActiveTexture(GL_TEXTURE14);
	glBindTexture(GL_TEXTURE_2D, t_cara_fuego6);
}
...
void display(void)
{
	...
	lightingShader.setInt("material_diffuse", t_cara_fuego1);
	//lightingShader.setInt("material_specular", t_caja_brillo);
	glDrawArrays(GL_QUADS, 0, 4);
	lightingShader.setVec3("ambientColor", 0.0f, 0.0f, 0.0f);
	lightingShader.setVec3("diffuseColor", 1.0f, 1.0f, 1.0f);
	lightingShader.setVec3("specularColor", 1.0f, 0.0f, 0.0f);
	lightingShader.setInt("material_diffuse", t_cara_fuego2);
	//lightingShader.setInt("material_specular", t_caja_brillo);
	glDrawArrays(GL_QUADS, 4, 8);
	lightingShader.setVec3("ambientColor", 0.0f, 0.0f, 0.0f);
	lightingShader.setVec3("diffuseColor", 1.0f, 1.0f, 1.0f);
	//lightingShader.setVec3("specularColor", 1.0f, 0.0f, 0.0f);
	lightingShader.setInt("material_diffuse", t_cara_fuego3);
	//lightingShader.setInt("material_specular", t_caja_brillo);
	glDrawArrays(GL_QUADS, 8, 12);
	lightingShader.setVec3("ambientColor", 0.0f, 0.0f, 0.0f);
	lightingShader.setVec3("diffuseColor", 1.0f, 1.0f, 1.0f);
	//lightingShader.setVec3("specularColor", 1.0f, 0.0f, 0.0f);
	lightingShader.setInt("material_diffuse", t_cara_fuego4);
	//lightingShader.setInt("material_specular", t_caja_brillo);
	glDrawArrays(GL_QUADS, 12, 16);
	lightingShader.setVec3("ambientColor", 0.0f, 0.0f, 0.0f);
	lightingShader.setVec3("diffuseColor", 1.0f, 1.0f, 1.0f);
	lightingShader.setVec3("specularColor", 1.0f, 0.0f, 0.0f);
	lightingShader.setInt("material_diffuse", t_cara_fuego5);
	//lightingShader.setInt("material_specular", t_caja_brillo);
	glDrawArrays(GL_QUADS, 16, 20);
	lightingShader.setVec3("ambientColor", 0.0f, 0.0f, 0.0f);
	lightingShader.setVec3("diffuseColor", 1.0f, 1.0f, 1.0f);
	lightingShader.setVec3("specularColor", 1.0f, 0.0f, 0.0f);
	lightingShader.setInt("material_diffuse", t_cara_fuego6);
	//lightingShader.setInt("material_specular", t_caja_brillo);
	glDrawArrays(GL_QUADS,20 ,25);
